    ...
    const playlists = this.props.playlists.map((playlist) => {
      return (
        <div className='album'>
          <button
            onClick={(e) => {
              this.updateSongCollection(e, playlist, playlist.id);
            }}
          ...
          <button
            onClick={(e) => {
              this.handleGoPlaylist(e, playlist.id);
            }}
    ...
    return (
      <div className='home'>
        <div className='library-header'>
          ...
          <button className='newPlaylist' onClick={this.openModal}>
            NEW PLAYLIST
          </button>
        </div>
